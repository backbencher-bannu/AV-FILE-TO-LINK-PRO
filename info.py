...
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002334132732')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002290275432')) # admin your channel in users log 
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'benclass10') # without @ 

# pics information
PICS = environ.get('PICS', 'https://envs.sh/_pM.jpg')

# channel link information
CHANNEL = environ.get('CHANNEL', 'https://t.me/ynvmovies')
SUPPORT = environ.get('SUPPORT', 'https://t.me/ynvmoviesrequest1')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harishwhatsapp0306:kumarbannu@cluster0.5uckjju.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")

# fsub  information
AUTH_PICS = environ.get('AUTH_PICS', 'https://envs.sh/AwV.jpg')              
AUTH_CHANNEL = (environ.get("AUTH_CHANNEL", "-1002226636138"))
